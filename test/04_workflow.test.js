                    ...
                    .end((err, res) => {
                        ...
                        chai.request(server)
                            ...
                            .end((err, res) => {
                                ...
                                expect(savedPizza.name).to.be.equal(Pizza.name);
                                expect(savedPizza.ingredients).to.be.equal(Pizza.ingredients);
                                expect(savedPizza.price).to.be.equal(Pizza.price);
                                expect(savedPizza.available).to.be.equal(Pizza.available);
                            ...
                            .end((err, res) => {
                                ...
                                chai.request(server)
                                    ...
                                    .end((err, res) => {
                                        ...
                                        expect(actualVal).to.be.equal('Pizza was successfully deleted.');        
                                        done();
                                    });
